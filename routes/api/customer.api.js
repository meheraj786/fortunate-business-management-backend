...
const { createCustomer, getAllCustomers, getCustomerById, updateCustomer, getCustomerStats } = require("../../controllers/customer.controller")
...
customerRoutes.delete("/delete-customer/:id", updateCustomer)
